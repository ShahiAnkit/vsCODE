    ...
    <main class="form-signin">
      <form method="POST" action="<?php echo $_SERVER['PHP_SELF'];?>" >
        ...
        <div class="form-floating">
          ...
          <button class="w-100 btn btn-lg btn-primary mt-3" type="submit">Submit and Log-in</button>
          <button class="w-100 btn btn-lg btn-primary mt-3"  type="submit"><a href="login.php" class="text-light">Login Page</button>
