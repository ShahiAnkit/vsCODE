...
<body>
    ...
    <div class="container">
        ...
        <p>Enter Your Details Below</p>
            ...
            <input type="text" name="name" id="name"  placeholder="Enter your Name" autocomplete="0">
            <input type="text" name="age" id="age" placeholder="Enter your Age" autocomplete="0">
            <input type="text" name="gender" id="gender" placeholder="Enter your Gender" autocomplete="0">
            <input type="email" name="email" id="email" placeholder="Enter your Email" autocomplete="0">
            <input type="text" name="phone" id="phone" placeholder="Enter your Phone" autocomplete="0">
