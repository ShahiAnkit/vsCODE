  ...
  <body style="background-color:rgb(219, 218, 218);text-align:center">
    ...
    <div class="container">
      ...
      <form method="POST" autocomplete="off" action="login.php" >
        ...
        <button style=" background: rgb(74, 75, 74); BORDER: 2PX SOLID WHITE" class="w-100 btn btn-lg btn-primary mt-3"  type="submit">Login</button>
        <button style=" background: rgb(74, 75, 74); BORDER: 2PX SOLID WHITE" class="w-100 btn btn-lg btn-primary mt-3"  type="submit"><a href="signup.php" class="text-light">Sign Up</button>
